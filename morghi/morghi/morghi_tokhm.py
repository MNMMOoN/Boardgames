...
class Tokhm(NonAnimal):
    ...
    def play(self, target=None):
        ...
        played_count = sum(1 for m in Tokhm.instances if m.times_played > 0)

        if played_count >= 2:
            print(f"Two or more Tokhm are in play! Special action triggered!")
